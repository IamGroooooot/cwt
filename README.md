...
When the default `.worktrees` directory is used, `cwt new` requires `.worktrees/` to already be gitignored (via the repo `.gitignore`, `.git/info/exclude`, or your global excludes file) and refuses to edit any file automatically.
